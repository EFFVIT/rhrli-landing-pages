...
export const metadata = {
  ...
  description:
    'Robotic FUE hair transplant on Long Island, performed by Dr. Raffi Barsoumian with the ARTAS® iXi system. Start with a doctor-led consultation: candidacy, graft count, timeline, and exact quote.',
...
const TRANSPLANT_FAQS = [
  {
    q: 'How does an FUE hair transplant work?',
    a: 'Follicular unit extraction (FUE) moves individual follicular units from the donor area at the back and sides of the head, where hair is typically resistant to pattern hair loss, into areas of thinning such as the hairline, temples, or crown. At RHRLI, harvesting is performed with the ARTAS® iXi robotic system for precision graft selection, and the procedure is done under local anesthetic in a single visit for most patients.',
  },
  {
    q: 'How many grafts will I need?',
    a: 'It depends on the size of the area being restored, your density goals, and your available donor supply. That is exactly what the consultation determines: Dr. Barsoumian assesses your hair loss pattern and donor area, then gives you a specific graft count and an exact quote, not a vague range.',
  },
  {
    q: 'What is recovery like after a hair transplant?',
    a: 'Most patients return to desk work within a few days. The small extraction and placement sites typically heal within 7 to 10 days. Because FUE harvests individual follicular units, there is no linear strip incision to heal. You will receive step-by-step aftercare instructions, and the team remains available for questions throughout recovery.',
  },
  {
    q: 'When will I see results?',
    a: 'Transplanted follicles shed their hairs in the first weeks, then enter a new growth cycle. New growth typically begins around three to four months, with results continuing to develop over 12 to 18 months. Individual results vary, and Dr. Barsoumian will walk you through a realistic timeline for your case at the consultation.',
  },
  {
    q: 'How much does a hair transplant cost on Long Island?',
    a: 'Hair transplant pricing is based primarily on the number of grafts your plan requires, which is why an honest quote requires an in-person assessment. Your consultation ends with an exact, itemized quote. Financing is available with payments as low as $188/month for qualified patients.',
  },
  {
    q: 'Will my hair transplant look natural?',
    a: 'Natural-looking results come from hairline design and graft placement: matching the angle, direction, and distribution of your existing hair. Dr. Barsoumian designs the hairline with you before the procedure and personally oversees placement. During your consultation he will show you what a realistic result looks like for your donor supply.',
  },
]

export default function HairTransplantConsultationLP() {
  return (
    <>
      ...
      <section style={{ background: '#09101f' }} className="hero-section">
        ...
        <div className="hero-image-card" style={{ position: 'relative', overflow: 'hidden', borderRadius: 20, background: '#15274f' }}>
          ...
          <div className="hero-badge" style={{
            ...
            <div>
              <div className="hero-badge-title" style={{ fontWeight: 700, color: '#fff' }}>Robotic Precision. Doctor-Led Results.</div>
              <div className="hero-badge-desc" style={{ color: 'rgba(255,255,255,0.85)', marginTop: 2 }}>
                ARTAS® iXi robotic FUE. Every procedure led by Dr. Barsoumian.
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="hero-content-col" style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
          <h1 style={{
            ...
            FUE Hair Transplant on Long Island
          </h1>
          <p style={{ color: 'rgba(255,255,255,0.85)', fontSize: '1rem', lineHeight: 1.65, marginBottom: 8 }}>
            Robotic follicular unit extraction performed by Dr. Raffi Barsoumian with the ARTAS® iXi system: precise graft harvesting, natural hairline design, and no linear strip incision.
          </p>
          <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '0.93rem', lineHeight: 1.6, marginBottom: 16 }}>
            It starts with a doctor-led consultation. Leave with your candidacy assessment, graft count, timeline, and an exact quote, before you decide anything.
          </p>

          <div style={{ display: 'flex', flexWrap: 'wrap', gap: 8, marginBottom: 24 }}>
            {['Doctor-performed', 'ARTAS® iXi robotic FUE', 'ISHRS member practice'].map(chip => (
              <span key={chip} style={{
          ...
          <div id="evaluation" style={{
            ...
            <p style={{ color: '#fff', fontWeight: 700, fontSize: '1.05rem', textAlign: 'center', marginBottom: 4 }}>
              Request Your Hair Transplant Consultation
            </p>
      ...
      <section style={{ background: '#fff', padding: '72px 40px 0' }}>
        <div style={{ maxWidth: 960, margin: '0 auto' }}>
          <h2 style={{ textAlign: 'center', fontSize: 'clamp(1.6rem, 3vw, 2rem)', fontWeight: 800, color: '#111', marginBottom: 8 }}>
            How Robotic FUE Hair Transplant Works
          </h2>
          <p style={{ textAlign: 'center', color: '#777', marginBottom: 48, fontSize: '0.95rem' }}>
            Follicular unit extraction, performed with robotic precision in a single visit for most patients.
          </p>

          <div className="steps-grid">
            {[
              { n: '1', title: 'DONOR HARVEST', desc: 'The ARTAS® iXi system identifies and extracts individual follicular units from the donor area at the back and sides of the head, where hair is typically resistant to pattern hair loss. No linear strip incision.' },
              { n: '2', title: 'HAIRLINE DESIGN', desc: 'Dr. Barsoumian designs your hairline and graft distribution with you, matched to your facial structure, age, and long-term hair loss pattern.' },
              { n: '3', title: 'GRAFT PLACEMENT', desc: 'Each graft is placed at the angle and direction of your existing hair across the hairline, temples, or crown, for density that grows in naturally.' },
            ].map(({ n, title, desc }) => (
          ...
          <div style={{ borderTop: '1px solid #E5E7EB', marginTop: 56, padding: '60px 0 72px', textAlign: 'center' }}>
            <h2 style={{ fontSize: 'clamp(1.5rem, 3vw, 2.2rem)', fontWeight: 800, color: '#111', lineHeight: 1.25, marginBottom: 12 }}>
              Whether it&apos;s a receding hairline, thinning<br />temples, or a thinning crown, it starts with candidacy.
            </h2>
            <p style={{ color: '#777', marginBottom: 32, fontSize: '0.95rem', maxWidth: 640, marginLeft: 'auto', marginRight: 'auto' }}>
              Not everyone is a candidate for hair transplant surgery, and Dr. Barsoumian will tell you honestly if you&apos;re not. If you are, you&apos;ll leave the consultation with a graft count, a timeline, and an exact quote.
            </p>
      ...
      <section style={{ background: CREAM, padding: '72px 40px' }}>
        <div style={{ maxWidth: 960, margin: '0 auto' }}>
          <h2 style={{ textAlign: 'center', fontSize: 'clamp(1.5rem, 3vw, 2rem)', fontWeight: 800, color: '#111', lineHeight: 1.25, marginBottom: 10 }}>
            Why Patients Choose RHRLI<br />for FUE Hair Transplant
          </h2>
          <p style={{ textAlign: 'center', color: '#777', marginBottom: 48, fontSize: '0.93rem' }}>
            Robotic precision. Candid consultations. Patient-first care from start to finish.
          </p>
          <div className="trust-grid">
            {([
              {
                title: 'ARTAS® iXi Robotic Technology',
                desc: 'Robotic follicular unit extraction for consistent, precise graft harvesting.',
              ...
              {
                title: 'Candid Candidacy Assessments',
                desc: 'Dr. Barsoumian will tell you if you\'re a strong candidate, and what realistic results look like for your donor supply.',
              ...
              {
                title: 'Doctor-Led, Every Procedure',
                desc: 'Dr. Barsoumian personally performs and oversees every hair transplant at RHRLI.',
              ...
              {
                title: 'Safe. Clinical. Medical-Grade.',
                desc: 'Strict medical standards and a clean clinical environment with hospital-grade protocols.',
              ...
              {
                title: 'Designed Around Your Pattern',
                desc: 'Plans built on hair loss stage, donor supply, and long-term goals, not a one-size template.',
              ...
              {
                title: 'Transparent About Costs and Recovery',
                desc: 'You\'ll know the full picture: graft count, investment, downtime, and timeline, before making any decision.',
              ...
              },
              {
                ...
                desc: 'Follow-up assessments to monitor growth milestones over the months after your procedure.',
              ...
              {
                title: 'ISHRS Member Practice',
                desc: 'Dr. Barsoumian is a member of the International Society of Hair Restoration Surgery.',
              ...
              {
                title: 'Thousands of Patients Treated',
                desc: 'Real patients, real reviews, and a track record on Long Island that speaks for itself.',
              ...
              },
              {
                ...
                desc: 'Learn your options, your candidacy, and your investment, no obligation.',
      ...
      <section style={{ background: '#fff', padding: '72px 40px' }}>
        <div style={{ maxWidth: 960, margin: '0 auto' }}>
          <h2 style={{ textAlign: 'center', fontSize: 'clamp(1.5rem, 3vw, 2rem)', fontWeight: 800, color: '#111', marginBottom: 8 }}>
            What to Expect: From Procedure Day to Full Growth
          </h2>
          <p style={{ textAlign: 'center', color: '#777', marginBottom: 48, fontSize: '0.93rem' }}>
            A realistic timeline, explained up front. Individual results vary.
          </p>
          <div className="steps-grid">
            {[
              { n: 'DAY 1', title: 'PROCEDURE DAY', desc: 'Performed under local anesthetic in a single visit for most patients. You go home the same day with clear aftercare instructions.' },
              { n: 'WK 1-2', title: 'EARLY HEALING', desc: 'Extraction and placement sites typically heal within 7 to 10 days. Most patients return to desk work within a few days.' },
              { n: 'MO 3-4', title: 'NEW GROWTH BEGINS', desc: 'Transplanted follicles enter a new growth cycle. Early growth typically starts around the third to fourth month.' },
              { n: 'MO 12-18', title: 'RESULTS DEVELOP', desc: 'Density continues building over 12 to 18 months, with follow-up assessments to track your growth milestones.' },
            ].map(({ n, title, desc }) => (
              <div key={n} style={{ textAlign: 'center', padding: '0 8px' }}>
                <div style={{
                  width: 72,
          ...
          <div className="two-col">
            ...
            <div>
              ...
              <p style={{ color: 'rgba(255,255,255,0.85)', lineHeight: 1.7, marginBottom: 16, fontSize: '0.95rem' }}>
                Dr. Raffi Barsoumian, MD, is the medical director at RHRLI and a Member of the International Society of Hair Restoration Surgery (ISHRS). He leads every hair transplant consultation personally and performs each FUE procedure alongside his clinical team.
              </p>
              <p style={{ color: 'rgba(255,255,255,0.85)', lineHeight: 1.7, marginBottom: 16, fontSize: '0.95rem' }}>
          ...
          <div className="two-col">
            <div>
              <h2 style={{ color: '#fff', fontSize: 'clamp(1.5rem, 2.8vw, 2rem)', fontWeight: 800, lineHeight: 1.25, marginBottom: 12 }}>
                What Does a Hair Transplant Cost on Long Island?
              </h2>
              <p style={{ color: 'rgba(255,255,255,0.75)', marginBottom: 12, fontSize: '0.95rem' }}>
                Pricing is based primarily on your graft count, which is why your consultation ends with an exact, itemized quote instead of a vague range.
              </p>
              <p style={{ color: 'rgba(255,255,255,0.75)', marginBottom: 28, fontSize: '0.95rem' }}>
                Flexible monthly plans make the investment manageable for real patients.
              </p>
              <div style={{
                background: '#122349',
                borderRadius: 12,
            ...
            <div style={{
              ...
              <img
                src={FINANCE_IMG}
                alt="Patient considering hair transplant options"
            ...
            {([
              {
                ...
                title: 'Capabilities',
                bullets: [
                  'ARTAS® iXi robotic follicular unit extraction (FUE)',
                  'Hairline, temple, and crown restoration planning',
                  'Comprehensive candidacy evaluation and donor analysis',
              ...
              },
              {
                ...
                bullets: [
                  'Evidence-based protocols reviewed by licensed medical providers',
                  'Clean, professional clinical environment with medical-grade standards',
                  'Clear pre-procedure and post-procedure guidance at every step',
                ],
              },
              {
                ...
                bullets: [
                  'Honest assessments: we only recommend what\'s right for your situation',
                  'Direct communication with Dr. Barsoumian at every step',
                  'Focus on natural-looking, long-term results',
                ],
              },
      ...
      <section style={{ background: '#fff', padding: '72px 40px' }}>
        <div style={{ maxWidth: 760, margin: '0 auto' }}>
          ...
          <FaqAccordion items={TRANSPLANT_FAQS} />
        </div>
      </section>
      ...
      <footer style={{
        ...
        <p style={{ maxWidth: 640, margin: '0 auto 20px', fontSize: '0.72rem', lineHeight: 1.6, color: 'rgba(255,255,255,0.4)' }}>
          Individual results vary. This content is for educational purposes only and is not medical advice. Candidacy for hair transplant surgery can only be determined through an in-person medical evaluation. Consult a qualified physician before pursuing any medical procedure.
        </p>
