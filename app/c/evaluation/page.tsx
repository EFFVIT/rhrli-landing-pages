...
const OG_IMAGE = 'https://more.rhrli.com/og/c-evaluation.webp'
        ...
        <div style={{ maxWidth: 960, margin: '0 auto' }}>
          ...
          <div className="steps-grid">
            {[
              ...
              { n: '4', title: 'PERSONALIZED TREATMENT PLAN', desc: 'Get a plan tailored to your needs, with no obligation to proceed.' },
            ].map(({ n, title, desc }) => (
