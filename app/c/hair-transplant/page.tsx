      ...
      <section style={{ background: NAVY }} className="hero-grid">
        <div style={{ position: 'relative', overflow: 'hidden', minHeight: 600 }}>
          ...
          <div style={{
            ...
            <div>
              ...
              <div style={{ fontWeight: 700, color: NAVY, fontSize: '0.9rem' }}>Robotic Precision. Doctor-Led Results.</div>
              <div style={{ color: '#555', fontSize: '0.82rem', marginTop: 2 }}>
                ARTAS® iX robotic technology. Every procedure led by Dr. Barsoumian.
              </div>
            </div>
          </div>
        </div>
        ...
        <div style={{ padding: '60px 48px 48px', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
          ...
          <p style={{ color: 'rgba(255,255,255,0.85)', fontSize: '1rem', lineHeight: 1.65, marginBottom: 8 }}>
            Find out if a hair transplant is the right option for you — including whether robotic FUE with the ARTAS® iX system fits your goals and donor supply.
          </p>
        ...
        <div style={{ maxWidth: 960, margin: '0 auto' }}>
          ...
          <div className="steps-grid">
            {[
              ...
              { n: '4', title: 'PERSONALIZED TREATMENT PLAN', desc: 'Receive a clear plan — options, timeline, and investment — before you decide anything.' },
            ].map(({ n, title, desc }) => (
      ...
      <section style={{ background: CREAM, padding: '72px 40px' }}>
        <div style={{ maxWidth: 960, margin: '0 auto' }}>
          ...
          <div className="trust-grid">
            {([
              {
                title: 'ARTAS® iX Robotic Technology',
            ...
            {([
              {
                ...
                title: 'Capabilities',
                bullets: [
                  'ARTAS® iX robotic follicular unit extraction (FUE)',
